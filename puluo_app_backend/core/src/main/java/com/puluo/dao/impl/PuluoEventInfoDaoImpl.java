		...
		try {
			...
			if (reader.queryForInt(querySQL)>0) {
				updateSQL = new StringBuilder().append("update ")
						.append(super.getFullTableName())
						.append(" set event_name = ").append(info.name()!=null ? "'" + info.name() + "'" : "null").append(",")
						.append(" description = ").append(info.description()!=null ? "'" + info.description() + "'" : "null").append(",")
						.append(" coach_name = ").append(info.coachName()!=null ? "'" + info.coachName() + "'" : "null").append(",")
						.append(" coach_uuid = ").append(info.coachUUID()!=null ? "'" + info.coachUUID() + "'" : "null").append(",")
						.append(" thumbnail_uuid = ").append(info.coachThumbnail()!=null ? "'" + info.coachThumbnail() + "'" : "null").append(",")
						.append(" details = ").append(info.details()!=null ? "'" + info.details() + "'" : "null").append(",")
						.append(" duration = ").append(info.duration() + ",")
				...
				updateSQL = new StringBuilder().append("insert into ")
						...
						.append(info.name()!=null ? "'" + info.name() + "'" : "null").append(", ")
						.append(info.description()!=null ? "'" + info.description() + "'" : "null").append(", ")
						.append(info.coachName()!=null ? "'" + info.coachName() + "'" : "null").append(", ")
						.append(info.coachUUID()!=null ? "'" + info.coachUUID() + "'" : "null").append(", ")
						.append(info.coachThumbnail()!=null ? "'" + info.coachThumbnail() + "'" : "null").append(", ")
						.append(info.details()!=null ? "'" + info.details() + "'" : "null").append(", ")
