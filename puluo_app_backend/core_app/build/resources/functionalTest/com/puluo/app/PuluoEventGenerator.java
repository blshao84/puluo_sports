...
public class PuluoEventGenerator {
	...
	public static void generateWeeklyEvents(DateTime dt) {
		...
		PuluoEventPoster poster11 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "dcddcc53-c348-4568-9274-97c400f29c5b.jpg", info1.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.ICON,1);
		PuluoEventPoster poster12 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "134c059a-7437-4de5-ba3d-f61839628cea.jpg", info1.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.POSTER,2);
		PuluoEventPoster poster13 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "c95bbdaa-34df-433f-a2f9-ed6c8c77df61.jpg", info1.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.POSTER,3);
		PuluoEventPoster poster14 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "78255c46-6aeb-4aa7-9378-8bcc011e94e5.jpg", info1.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.POSTER,4);
		
		PuluoEventPoster poster21 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "6181964f-ed5e-4c3a-82de-90dd94dbba30.jpg", info2.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.ICON,1);
		PuluoEventPoster poster22 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "de769d22-aa0f-4869-9921-37b1375ef752.JPG", info2.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.POSTER,2);
		PuluoEventPoster poster23 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "a8eecd74-cc0e-498d-a872-1faa6a6380f1.jpg", info2.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.POSTER,3);
		PuluoEventPoster poster24 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "08134564-8f4c-425f-8c7c-b5faee9d367a.jpg", info2.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.POSTER,4);
		
		PuluoEventPoster poster31 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "0b6d9f58-4017-4e3c-8397-b497d8dbde81.jpeg", info3.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.ICON,1);
		PuluoEventPoster poster32 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "ec780169-2970-419c-87e1-44f30685cc78.jpg", info3.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.POSTER,2);
		PuluoEventPoster poster33 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "f61fa44a-f583-4cc2-93ee-e3818c2d2671.jpg", info3.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.POSTER,3);
		PuluoEventPoster poster34 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "9b5a7285-8111-4f97-88b0-bc869dd887de.jpg", info3.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.POSTER,4);
		PuluoEventPoster poster35 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "4a8be1e2-889d-4845-8968-9682807af68f.jpg", info3.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.POSTER,5);
		
		PuluoEventPoster poster41 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "152b7961-5905-4b73-81cb-8fbee3267794.jpg", info4.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.ICON,1);
		PuluoEventPoster poster42 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "d078c73e-0863-45f3-bd20-594891b57722.jpg", info4.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.POSTER,2);
		PuluoEventPoster poster43 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "ba30569e-d65a-4ca9-8bcd-527cecd85a48.jpg", info4.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.POSTER,3);
		PuluoEventPoster poster44 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "ec7233d8-4486-4692-ac7e-dcd3eda7b68e.jpg", info4.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.POSTER,4);
		PuluoEventPoster poster45 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "912786df-7396-42b4-9801-ee010309fd3c.JPG", info4.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.POSTER,5);

		PuluoEventPoster poster51 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "7e8f086c-ede1-4243-af96-cd4427611ad3.jpeg", info5.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.ICON,1);
		PuluoEventPoster poster52 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "c478355e-ce1b-443b-92c3-ab5c79f1f632.jpg", info5.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.POSTER,2);
		PuluoEventPoster poster53 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "fe89067b-b153-4952-b35b-ff97aecf3b87.jpg", info5.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.POSTER,3);
		PuluoEventPoster poster54 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "d2b4a9cf-2a01-4457-86a3-5cd1f4a030f0.jpg", info5.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.POSTER,4);
		PuluoEventPoster poster55 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "b1d11084-be0c-47bb-9b0f-ca7efdf4693f.jpg", info5.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.POSTER,5);
		
		PuluoEventPoster poster61 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "4fc064b5-adb0-47f5-a0a0-ebca6b4ea68b.jpg", info6.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.ICON,1);
		PuluoEventPoster poster62 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "8950aac6-b6cc-4660-be6a-28f888d49985.jpeg", info6.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.POSTER,2);
		PuluoEventPoster poster63 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "d0ca2c84-4f3c-41f2-a0a7-d44830d3c6be.jpg", info6.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.POSTER,3);
		PuluoEventPoster poster64 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "e9c633a3-75ad-4d00-a010-b5119be6ec6d.jpg", info6.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.POSTER,4);
		
		PuluoEventPoster poster71 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "4fc074b5-adb0-47f5-a0a0-ebca7b4ea78b.jpg", info7.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.ICON,1);
		PuluoEventPoster poster72 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "8950aac7-b7cc-4770-be7a-28f888d49985.jpeg", info7.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.POSTER,2);
		PuluoEventPoster poster73 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "d0ca2c84-4f3c-41f2-a0a7-d44830d3c7be.jpg", info7.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.POSTER,3);
		PuluoEventPoster poster74 = new PuluoEventPosterImpl(
				UUID.randomUUID().toString(), "e9c733a3-75ad-4d00-a010-b5119be7ec7d.jpg", info7.eventInfoUUID(), DateTime.now(),PuluoEventPosterType.POSTER,4);
