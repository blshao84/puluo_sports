...
(function($) {
	...
	$.blockUI.defaults = {
		...
		// force usage of iframe in non-IE browsers (handy for blocking over
		// objects and applets)
		forceIframe : false,
	...
	function install(el, opts) {
		...
		var lyr1 = ($.browser.msie) ? $('<iframe class="blockUI" style="z-index:'
				+ (z++)
		...
		var lyr2 = $('<div class="blockUI blockOverlay" style="z-index:'
				+ (z++)
				+ ';display:none;cursor:wait;border:none;margin:0;padding:0;width:100%;height:100%;top:0;left:0"></div>');
	...
	function bind(b, el, opts) {
		...
		if (b && !opts.showOverlay) // don't prevent events when overlay not in
									// use
			return;
