...
public class PaymentLinkFunctionalTest extends APIFunctionalTest {
	
	public static Log log = LogFactory.getLog(PaymentLinkFunctionalTest.class);
	...
	private static String order_uuid = UUID.randomUUID().toString();
