package com.unuotech.payment.example;

import java.text.SimpleDateFormat;
import java.util.Date;

import com.unuotech.payment.config.UnionPayConf;
import com.unuotech.payment.unionpay.utils.UnionPayUtils;
...
public class UnionPayBack{
	...
	public void doBackTrans() {
		...
		String[] valueVo = new String[]{
	            ...
	            "04",//交易类型
	            "",//原始交易流水号
	            UnionPayConf.merCode,//商户代码
	            UnionPayConf.merName,//商户简称
	            "",//收单机构代码（仅收单机构接入需要填写）
	            "",//商户类别（收单机构接入需要填写）
	            "",//商品URL
	            "",//商品名称
	...
	public String getUnionPaySyncRes(String[] valueVo) {
		UnionPayUtils quickPayUtils = new UnionPayUtils();
		return quickPayUtils.doPostQueryCmd(UnionPayConf.backStagegateWay,new UnionPayUtils().createBackStrForBackTrans(valueVo, UnionPayConf.reqVo));
