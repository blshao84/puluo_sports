...
public class UnionPaySampleServLet extends HttpServlet {
	/**
	 * 
	 */
	...
	public void service(HttpServletRequest request, HttpServletResponse response) {
		...
		String html = new UnionPayUtils().createPayHtml(valueVo, signType);// 跳转到银联页面支付
	...
	public static void main(String[] args) {
		...
		String html = new UnionPayUtils().createPayHtml(valueVo, UnionPayConf.signType);// 跳转到银联页面支付
