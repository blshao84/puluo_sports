...
public class UnionPayQuery{
	...
	public static void main(String[] aa){
		new UnionPayQuery().queryTrans("01", "201104181312393", "20110523194505");
	}
	...
	public String query(String transType, String orderNumber, String orderTime) {
		...
		return quickPayUtils.doPostQueryCmd(UnionPayConf.queryUrl,new UnionPayUtils().createBackStr(valueVo, UnionPayConf.queryVo));
