...
//	private final static String UPOP_QUERY_BASE_URL = "https://www.epay.lxdns.com/UpopWeb/api/";
	...
	// 支付网址
	public final static String gateWay = "https://payment.ChinaPay.com/pay/TransGet";//UPOP_BASE_URL + "Pay.action";
	...
	public final static String[] reqVo2 = new String[]{
		"MerId","OrdId","TransAmt","CuryId","TransDate","TransType","Version","BgRetUrl",
		"PageRetUrl","GateId","Priv1","ClientIp","ChkValue"
	};
	//组装消费请求包
